...
//                            currentX = x;
//                            currentY = y;
//                            targetcell = jPanelSquareGrid[rank][file+2];
//                            Point targetPosition = targetcell.getLocation();
//                            
////                            JPanelSquare temp = jPanelSquareGrid[rank][file];
////                            System.out.println("MousePos x " + p.x);
////                            System.out.println("Cell x " + temp.getLocation().x);
                ...
                for (int file = 0; file < jPanelSquareGrid[rank].length; file++) {
                    if (jPanelSquareGrid[rank][file] == c) {
                        if (jPanelSquareGrid[rank][file].getChessPiece() != null) {
                            ...
                            mainLayeredPane.repaint();
                            // Check
//                            JPanelSquare cell = jPanelSquareGrid[rank][file+2];
//                            Point targetPosition = cell.getLocationOnScreen();
...
//			//on each update:
//			double amountToMoveX = 1;//xValue / (2 * 60);
//			double amountToMoveY = yValue / (2 * 60);
//			currentX += amountToMoveX;
//			//currentY += amountToMoveY;
//			System.out.println("currentX " + currentX);
//			System.out.println("destinationX " + destinationX);
//			System.out.println("amountToMoveX " + amountToMoveX);
//			
